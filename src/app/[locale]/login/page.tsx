      ...
      <div className="flex flex-col items-center justify-center md:order-first md:w-1/2 ">
        <Card className="border-none md:w-[60%] mt-[10%]">
          <CardHeader>
            <p className="text-3xl ">
              {t("welcome")} <b className="md:hidden">{t("back")}</b>
            </p>
          ...
          <CardFooter>
            <p className="text-custom-gray flex items-center justify-center w-full">
        ...
        <div>
          <footer className="text-custom-gray text-sm mt-8 text-center">
            <p className="">
              {" "}
              <b className="font-bold">{t("mbadrh")}</b>
              {t("hna-ytkhrj-alqadh")}{" "}
            </p>
            <p>
              <b className="font-bold"></b> {t("initiativePart2")}
            </p>
          </footer>
        </div>
      </div>
